...
class URLShortner {
    ...
    private int count = 0;
    private HashMap<String, HashMap<String, Integer>> map = new HashMap<String, HashMap<String, Integer>>();
    
    public final String randomString = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
    ...
    public void displayInfo(){
        System.out.println("Just showing Info");
    ...
    public void listAllInfo(){
        ...
        for ( String key : map.keySet() ) {
             ...
             for ( String innerKey : innerMap.keySet() ) {
               System.out.println( innerKey + " short link-" + innerMap.get(innerKey) );
               System.out.println("value for this url " + url +" is:- " + innerKey);
               System.out.println("count for this url:-" + innerMap.get(innerKey));
            }
        }
    }
}
